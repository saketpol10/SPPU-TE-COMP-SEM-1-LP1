...
FileReader("C:\\Users\\Gites\\OneDrive\\Documents\\New folder\\javaprograms\\input.txt"));
File op = new File("C:\\Users\\Gites\\OneDrive\\Documents\\New folder\\javaprograms\\pass1output.txt");
if (!op.exists())
op.createNewFile();
